...
const foodSections = [
    {
        sectionId: 'starter', type: 'food', order: 0,
        titleEn: 'Starters', titleHe: 'תוספי מנוע', titleRu: 'Стартеры',
        items: [
    ...
    {
        sectionId: 'marine', type: 'food', order: 1,
        titleEn: 'Marine Fuel', titleHe: 'דלק ימי', titleRu: 'Морское топливо',
        items: [
    ...
    {
        sectionId: 'ground', type: 'food', order: 2,
        titleEn: 'Ground Fuel', titleHe: 'דלק יבשתי', titleRu: 'Наземное топливо',
        items: [
            ...
            { titleEn: 'Frankfurters + Chips + Sauerkraut', titleRu: 'Колбаски + Чипс + Квашеная капуста',
                titleHe: 'נקניקיות פרנקפורט + צ\'יפס + כרוב כבוש', image: 'sausage_chips_cabbage.jpg', cost1: 90 },
            ...
            { titleEn: 'Vareniki with potato', titleRu: 'Вареники с картошкой',
                titleHe: 'ורניקי עם תפוחי אדמה', image: 'vareniki_potato.jpg', cost1: 50 },
            { titleEn: 'Vareniki with cottage cheese', titleRu: 'Вареники с творогом',
                titleHe: 'פסטה ברוטב שמנת או שמנת ופטריות עם פרמזן', image: 'vareniki_cottage.jpg', cost1: 50 },
            { titleEn: 'Meat blintzes', titleRu: 'Блинчики с мясом',
                titleHe: 'ורניקי עם גבינת כפר', image: 'blintzes_meat.jpg', cost1: 50 },
            { titleEn: 'Blintzes with cottage cheese or cherry', titleRu: 'Блинчики с вишней или творогом',
                titleHe: "בלינצ'ס עם גבינה או דובדבנים", image: 'blintzes_cherry.jpg', cost1: 50 }
        ]
    }
];
...
const dessertSections = [
    {
        sectionId: 'dessert', type: 'dessert', order: 0,
        titleEn: '', titleHe: '', titleRu: '',
        items: [
...
const barSections = [
    { sectionId: 'cooling', type: 'bar', order: 0, titleEn: 'Cooling agents', titleHe: 'קררים', titleRu: 'Хладогенты', items: [] },
    {
        sectionId: 'draft', type: 'bar', order: 1,
        titleEn: 'Draft', titleHe: 'חבית', titleRu: 'Бочка',
        items: [
            { titleEn: 'Budvar Czech Dark Lager', titleRu: 'Будвар чешское темное',
                titleHe: 'בודבר דארק לאגר צ\'כי', image: 'budvar.jpg',
                cost1: 25, cost2: 35, cap1: '1/3 L', cap2: '1/2 L' },
            { titleEn: 'Budvar Czech Lager', titleRu: 'Будвар чешское светлое',
                titleHe: 'בודבר בהירה לאגר צ\'כי', image: 'budvar_light.jpg',
                cost1: 25, cost2: 35, cap1: '1/3 L', cap2: '1/2 L' },
            { titleEn: 'Řezák layered beer', titleRu: 'Ржезак (резаное пиво)',
                titleHe: 'בירת רז׳אק', image: 'rezak.jpg',
                cost1: 25, cost2: 35, cap1: '1/3 L', cap2: '1/2 L' },
    ...
    {
        sectionId: 'bottled', type: 'bar', order: 2,
        titleEn: 'Bottled', titleHe: 'בקבוק', titleRu: 'Бутылка',
        items: [
            { titleEn: 'Heineken 00', titleRu: 'Хайникен 00', titleHe: 'היינקן 00',
                image: 'heineken_00.jpg', cost1: 25, cap1: '1/3 L' },
            { titleEn: 'Heineken', titleRu: 'Хайникен', titleHe: 'היינקן',
                image: 'heineken.jpg', cost1: 30, cap1: '1/2 L' },
            { titleEn: 'Corona', titleRu: 'Корона', titleHe: 'קורונה',
                image: 'corona.jpg', cost1: 25, cap1: '1/3 L' },
            { titleEn: 'Kasteel Rubus', titleRu: 'Кастиль Рубус', titleHe: 'קסטיאל רובוס',
                image: 'kasteel_rubus.jpg', cost1: 35, cap1: '1/3 L' },
            { titleEn: 'Kasteel Tropical', titleRu: 'Кастиль Тропикал', titleHe: 'קסטיאל טרופיקל',
                image: 'kasteel_tropical.jpg', cost1: 35, cap1: '1/3 L' },
            { titleEn: 'Kasteel Rouge 00', titleRu: 'Кастиль Руж 00', titleHe: 'קסתלה רוגי 00',
                image: 'kasteel_00.jpg', cost1: 35, cap1: '1/3 L' }
        ]
    },
    { sectionId: 'fuel', type: 'bar', order: 3, titleEn: 'Fuel', titleHe: 'תוספי מנוע', titleRu: 'Топливо', items: [] },
    {
        sectionId: 'whiskey', type: 'bar', order: 4,
        titleEn: 'Whiskey', titleHe: 'וויסקי', titleRu: 'Виски',
        items: [
            { titleEn: 'Jameson', titleRu: 'Джеймсон', titleHe: 'ג\'יימסון',
                image: 'jameson.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' },
            ...
            { titleEn: 'Johnnie Walker Red Label', titleRu: 'Джони Уолкер Ред Лейбл',
                titleHe: 'ג\'וני ווקר רד לייבל', image: 'red_label.jpg',
    ...
    {
        sectionId: 'vodka', type: 'bar', order: 5,
        titleEn: 'Vodka', titleHe: 'וודקה', titleRu: 'Водка',
        items: [
            ...
            { titleEn: 'Van Gogh', titleRu: 'Ван Гог', titleHe: 'ואן גוך',
                image: 'van_gogh.jpg', cost1: 30, cost2: 45, cap1: '30ml', cap2: '50ml' }
        ]
    },
    {
        sectionId: 'rum', type: 'bar', order: 6,
        titleEn: 'Rum', titleHe: 'רום', titleRu: 'Ром',
        items: [
            { titleEn: 'Bacardi', titleRu: 'Бакарди', titleHe: 'בקרדי',
                image: 'bacardi.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' },
    ...
    {
        sectionId: 'cognac', type: 'bar', order: 7,
        titleEn: 'Cognac', titleHe: 'קוניאק', titleRu: 'Коньяк',
        items: [
    ...
    {
        sectionId: 'gin', type: 'bar', order: 8,
        titleEn: 'GIN', titleHe: 'ג\'ין', titleRu: 'Джин',
        items: [
            { titleEn: 'Bombay', titleRu: 'Бомбей', titleHe: 'בומביי',
                image: 'bombay.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' },
            { titleEn: 'Befeater', titleRu: 'Бифитер', titleHe: 'ביפיטר',
                image: 'befeater.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' }
        ]
    },
    {
        sectionId: 'tequila', type: 'bar', order: 9,
        titleEn: 'Tequila', titleHe: 'טקילה', titleRu: 'Текила',
        items: [
    ...
    {
        sectionId: 'absent', type: 'bar', order: 10,
        titleEn: 'Absent', titleHe: 'אבסנט', titleRu: 'Абсент',
        items: [
            { titleEn: 'La Cour', titleRu: 'Ла Кур', titleHe: 'לה קור',
                image: 'la_cour.jpg', cost1: 30, cost2: 45, cap1: '30ml', cap2: '50ml' }
        ]
    },
    {
        sectionId: 'ouzo', type: 'bar', order: 11,
        titleEn: 'Ouzo', titleHe: 'אוזו', titleRu: 'Узо',
        items: [
            { titleEn: 'Plomari', titleRu: 'Пломари', titleHe: 'פלומרי',
                image: 'plomari.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' }
        ]
    },
    {
        sectionId: 'liker', type: 'bar', order: 12,
        titleEn: 'Likers', titleHe: 'ליקרים', titleRu: 'Ликеры',
        items: [
            { titleEn: 'Jagermeister', titleRu: 'Егермейстер', titleHe: 'יגרמייסטר',
                image: 'jagermeister.jpg', cost1: 20, cost2: 30, cap1: '30ml', cap2: '50ml' }
        ]
    },
    { sectionId: 'mix', type: 'bar', order: 13, titleEn: 'Fuel Mixture', titleHe: 'תערובות בעירה', titleRu: 'Топливные смеси', items: [] },
    {
        sectionId: 'mixture', type: 'bar', order: 14,
        titleEn: '2 component mixture', titleHe: 'תערובת של 2', titleRu: '2-х компонентные смеси',
        items: [
            { titleEn: 'Whiskey-Cola', titleRu: 'Виски-Кола', titleHe: 'וויסקי-קולה', image: 'whiskey_cola.jpg', cost1: 40 },
            { titleEn: 'Rum-Cola', titleRu: 'Ром-Кола', titleHe: 'רום-קולה', image: 'rom_cola.jpg', cost1: 40 },
            { titleEn: 'Vodka-XL', titleRu: 'Водка-XL', titleHe: 'וודקה-אקסל', image: 'vodka_xl.jpg', cost1: 40 },
            { titleEn: 'Gin-Tonic', titleRu: 'Джин-Тоник', titleHe: 'ג\'ין-טוניק', image: 'jin_tonic.jpg', cost1: 40 },
            { titleEn: 'Screwdriver', titleRu: 'Отвертка', titleHe: 'סקרודרייבר', image: 'otvertka.jpg', cost1: 40 },
            { titleEn: 'Vodka-Cranberries', titleRu: 'Водка-Клюква', titleHe: 'וודקה-חמוציות', image: 'vodka_klukva.jpg', cost1: 40 },
            { titleEn: 'Frozen Margarita', titleRu: 'Снежная Маргарита', titleHe: 'מרגריטה קפואה', image: 'margarita.jpg', cost1: 40 }
        ]
    },
    {
        sectionId: 'dot', type: 'bar', order: 15,
        titleEn: 'DOT 4', titleHe: 'דוט 4', titleRu: 'ДОТ 4',
        items: [
            { titleEn: 'Martini Bianco', titleRu: 'Мартини Бьянко', titleHe: 'מרטיני ביאנקו', image: 'martini_bianco.jpg', cost1: 50 },
            { titleEn: 'Martini Rosso', titleRu: 'Мартини Россо', titleHe: 'מרטיני רוסו', image: 'martini_rosso.jpg', cost1: 50 },
            { titleEn: 'Lambrusco', titleRu: 'Ламбруско', titleHe: 'למברוסקו', image: 'lambrusco.jpg', cost1: 40 },
            { titleEn: 'Сava', titleRu: 'Кава', titleHe: 'קאווה', image: 'cava.jpg', cost1: 40 },
            { titleEn: 'Prosecco', titleRu: 'Просекко', titleHe: 'פרוסקו', image: 'prosecco.jpg', cost1: 40 },
            { titleEn: 'Red wine', titleRu: 'Красное вино', titleHe: 'יין אדום', image: 'red_wine.jpg', cost1: 40 },
            { titleEn: 'White wine', titleRu: 'Белое Вино', titleHe: 'יין לבן', image: 'white_wine.jpg', cost1: 40 },
            { titleEn: 'Aperol-Spritz', titleRu: 'Апероль-Шприц', titleHe: 'אפרול-שפריץ', image: 'aperol_spritz.jpg', cost1: 40 },
            { titleEn: 'Campari', titleRu: 'Кампари', titleHe: 'קמפארי', image: 'campari.jpg', cost1: 65 }
        ]
    },
    {
        sectionId: 'soft', type: 'bar', order: 16,
        titleEn: 'Non-alcoholic drinks', titleHe: 'משקאות קלים', titleRu: 'Без градуса',
        items: [
            { titleEn: 'Soft drinks', titleRu: 'Безалкогольные напитки', titleHe: 'שתייה קלה', image: 'juice.jpg', cost1: 10 },
            { titleEn: 'Bottled water', titleRu: 'Вода в бутылке', titleHe: 'מים בבקבוק', image: 'water.jpg', cost1: 10 },
            { titleEn: 'Espresso or Americano', titleRu: 'Эспрессо/Американо', titleHe: 'אספרסו ואמריקנו', image: 'coffee.jpg', cost1: 10 }
        ]
    }
];
...
const eventsData = [
    {
        ...
        date: '2025-04-03', open: '20:00', start: '21:00', price: 40, order: 0
    },
    {
        ...
        date: '2025-04-04', open: '20:00', start: '21:00', price: 70, order: 1
    }
];

const albumsData = [
    {
        titleEn: 'The Jockers', titleRu: 'The Jockers', titleHe: 'The Jockers',
        date: '2025-03-14', order: 0,
    ...
    {
        titleEn: 'Club house opening', titleRu: 'Открытие club house', titleHe: 'פתיחה club house',
        date: '2025-03-13', order: 1,
    ...
    {
        titleEn: 'Desmodiym', titleRu: 'Desmodiym', titleHe: 'Desmodiym',
        date: '2025-03-07', order: 2,
    ...
    {
        titleEn: 'Grand open', titleRu: 'Грандиозное открытие', titleHe: 'פתיחה חגיגית',
        date: '2025-03-06', order: 3,
...
async function seed() {
    ...
    await MenuSection.insertMany([...foodSections, ...dessertSections, ...barSections]);
